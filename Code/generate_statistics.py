...
if __name__ == "__main__":
    ...
    npzfile = np.load('/Users/asmakhimani/Dialysis_COVID19/dialysis/contact_data/patient_arrays_day10_1ft.npz')
    ...
    npzfile = np.load('/Users/asmakhimani/Dialysis_COVID19/dialysis/contact_data/hcw_arrays_day10_1ft.npz')
    ...
    print(f"Number of HCPs: {n_hcw}")
    print(f"Number of Patients: {n_patient}")
    ...
    df_additional_statistics.to_csv("tables/statistics/additional_network_statistics_mrsa.csv") 
